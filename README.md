# noname
Having game "Space Rangers HD: A War Apart", I'd like ot create something similar, but better. Will keep turn-based strategy approach, with enhancement of rangers having their own colonies (which they should defend, improve). it's a huge game, so I'd rather start from something simple, and then build up the game I want
